...
var ExampleCollectionPlugin,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

ExampleCollectionPlugin = (function(superClass) {
  extend(ExampleCollectionPlugin, superClass);

  function ExampleCollectionPlugin() {
    return ExampleCollectionPlugin.__super__.constructor.apply(this, arguments);
  }

  ExampleCollectionPlugin.prototype.getCurrentTools = function(collection) {
  ...
  ExampleCollectionPlugin.prototype.__runModalExample = function(objects) {
  ...
  return ExampleCollectionPlugin;

})(CollectionPlugin);

ez5.session_ready(function() {
  return Collection.registerPlugin(new ExampleCollectionPlugin());
});
